            ...
            <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
                ...
                <form onSubmit={formSubmit} ref={form}>
                  ...
                  <div className="input-box message-box">
                      <textarea name='message' id="message" placeholder="Add a message here" cols={60} rows={8} className="text-black"></textarea>
                      </div>
                      <button type="submit" value="Send" className="btn btn-complement-pacorange mt-4" style={{fontFamily:"inherit"}} >Send Message</button>
                      </form>
                      </div>
